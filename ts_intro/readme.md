...
> __disclaimer:__ это не туториал, это не учебник по TypeScript, это что-то другое. Этой заметке я во многом капитанствую и пишу для кого-то очевидные вещи. В заметке вы наверняка найдет как грамматические ошибки, не стесняйтесь исправлять и предлагать исправления. А еще тут возможны и концептуально не правильное понимание концепций мной -- за разъяснения и исправления таких ошибок я буду особенно благодарен.
...
Подборка всего, что так или иначе транслируется в JavaScript опубликована [на github в wiki](https://github.com/ashkenas/coffeescript/wiki/list-of-languages-that-compile-to-js) одного из ярких представителей семейства -- CoffeScript.
